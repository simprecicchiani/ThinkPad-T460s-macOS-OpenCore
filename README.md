...
Data generated by CPUFriend are inside SSDT-CPU
...
If you have a different CPU model, please, **~~remove these kexts~~ replace SSDT-CPU with plain SSDT-PLUG** found in EFI (first boot), power management is natevely supported by OpenCore anyway.
